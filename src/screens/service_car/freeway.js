    ...
    return (
        ...
        <View style={{
            ...
            <ScrollView style={{ width: "100%" }} contentContainerStyle={{ alignItems: "center", }}>
                ...
                <Text style={{ fontFamily: "MontserratBold", fontSize: 15, color: Colors.background, marginTop: 10 }}>عوارض آزادراهی</Text>
                <Text style={{ fontFamily: "MontserratBold", fontSize: 15, color: Colors.background, marginTop: 5 }}>مجموع بدهی : 286،523،123 ریال</Text>
                ...
                <View style={{ flexDirection: "column", width: "90%", height: 130, backgroundColor: Colors.black2, marginTop: 15, borderRadius: 10, alignItems: "center", justifyContent: "space-around" }}>
                    ...
                    <View style={{ width: "95%", height: 30, backgroundColor: Colors.black2, flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 15 }}>
                        <Text style={{ fontFamily: "MontserratBold", fontSize: 18, color: Colors.background }}>286،523،123 ریال</Text>
                        <Text style={{ fontFamily: "MontserratBold", fontSize: 15, color: Colors.secondText }}>عوارض آزادراهی</Text>
                    </View>

                    <TouchableOpacity style={{ width: "90%", height: 50, borderWidth: 2, borderColor: Colors.primary, borderRadius: 10, justifyContent: "center", alignItems: "center" }}>
