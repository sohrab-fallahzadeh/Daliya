  ...
  return (
    ...
    <View style={{
      ...
      <HeaderBar
        ...
        text={{ fontSize: 15 }}
        namepage=" تهران به دبی 1403/02/17"
      ...
      <ScrollView style={{ width: "100%", padding: 5 }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => props.navigation.navigate("checkticketexternal")}
          style={{ flexDirection: "column", width: "100%", alignSelf: "auto", justifyContent: "flex-start", alignItems: "center", backgroundColor: Colors.black4, borderRadius: 10, marginTop: 10 }}>
          ...
          <View style={{ width: "40%", height: "20%", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", position: "absolute", left: 5, marginTop: 10 }}>
            <Text style={{ fontFamily: "MontserratBold", fontSize: 11, color: Colors.background, position: "absolute", top: 25, left: 8 }}>IKA</Text>
            ...
            <Text style={{ fontFamily: "MontserratBold", fontSize: 11, color: Colors.background, position: "absolute", top: 25, right: 8 }}>NJF</Text>
          </View>

          <SafeAreaView style={{ width: "100%", height: 70, justifyContent: "center" }}>
            ...
            <View style={{ width: "40%", height: "30%", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", position: "absolute", left: 5, top: "25%", }}>
          ...
          <View style={{ width: "100%", flexDirection: "row", borderColor: Colors.secondText3, marginTop: 10 }}>




            <View style={{ width: "20%", alignItems: "center", justifyContent: "center", backgroundColor: Colors.success, borderRadius: 10, marginLeft: 8 }}>
            ...
            <View style={{ width: "20%", alignItems: "center", justifyContent: "center", backgroundColor: Colors.blue, borderRadius: 10, marginLeft: 8 }}>
          ...
          <View style={{ width: "100%", flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginTop: 20, marginBottom: 10 }}>
